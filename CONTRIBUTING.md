...
quality to benefit the project.
Many developers have different skills, strengths, and weaknesses.
...
- **Add tests!** — Your patch won't be accepted if it didn't have tests.
