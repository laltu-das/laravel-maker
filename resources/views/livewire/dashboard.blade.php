<div>
    <div class="bg-gray-50 dark:bg-gray-950 min-h-screen">
        <div class="flex bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-white">
            <aside class="flex h-auto w-20 flex-col items-center border-r border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-white">
                ...
                <nav class="flex flex-1 flex-col gap-y-4 pt-10">
                    <a href="#" wire:click="switchTab('tab1')" class="group relative rounded-xl bg-gray-100 p-2 text-blue-600 hover:bg-gray-50">
                    ...
                    <a href="#" wire:click="switchTab('tab1')" class="text-gary-400 group relative rounded-xl p-2 hover:bg-gray-50">
                    ...
                    <div class="py-3 sm:py-5 mx-auto border-b border-gray-200 dark:border-gray-900">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2 text-lg sm:text-2xl text-gray-700 dark:text-gray-300 font-medium"><b class="font-bold">Laravel</b> Maker</span>
                            </div>
